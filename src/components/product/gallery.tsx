  ...
  return (
    <div className="space-y-4">
      <div
        ...
        className="well group relative aspect-square overflow-hidden rounded-[1.75rem]"
      >
      ...
      <div className="flex gap-3">
        {images.map((image, i) => (
          <button
            ...
            className={cn(
              "well relative aspect-square w-20 shrink-0 overflow-hidden rounded-xl border transition-all duration-300 sm:w-[5.5rem]",
              i === index
