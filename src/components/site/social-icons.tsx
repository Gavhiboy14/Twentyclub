...
export function TikTokIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden className={className}>
      <path d="M16.6 2h-2.83v13.03a2.62 2.62 0 1 1-2.62-2.62c.2 0 .4.02.59.07V9.6a5.6 5.6 0 0 0-.59-.03 5.47 5.47 0 1 0 5.47 5.47V8.5a6.6 6.6 0 0 0 3.88 1.25V6.9a3.8 3.8 0 0 1-2.72-1.18A3.85 3.85 0 0 1 16.6 2Z" />
    </svg>
  );
}
