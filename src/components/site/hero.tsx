  ...
  return (
    ...
    >
      ...
      {!reduced && (
        ...
        >
          <div className="size-full rounded-full bg-[radial-gradient(circle,rgba(247,244,224,0.3),transparent_65%)]" />
        </motion.div>
      )}
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[1.05fr_1fr] lg:gap-6">
        ...
        <motion.div style={{ opacity: fade }} className="relative z-20 max-w-xl">
          ...
          >
            <Sparkle className="size-2.5 text-cream" />
            {banner.eyebrow}
          </motion.p>

          <h1 className="display-wide text-[clamp(2.75rem,8.5vw,5.5rem)] text-cream">
        ...
        <div className="relative z-10 flex items-center justify-center lg:h-[38rem]">
          <motion.p
            aria-hidden
            style={{ y: typeY }}
            className="display-wide pointer-events-none absolute inset-x-0 top-1/2 -z-10 -translate-y-1/2 select-none text-center text-[clamp(6rem,22vw,17rem)] leading-none text-transparent"
          >
            <span
              className="bg-linear-to-b from-cream/[0.13] to-cream/[0.01] bg-clip-text"
          ...
          >
            ...
            <motion.div
              ...
              className="glass edge-light absolute bottom-2 left-2 flex items-center gap-4 rounded-2xl px-4 py-3 sm:bottom-6 sm:left-6"
            >
              <div>
              ...
              <div className="text-right">
                ...
                <Link
                  ...
                  className="font-mono text-[0.625rem] uppercase tracking-[0.16em] text-sand transition-colors hover:text-cream"
                >
                  Ver ficha
                </Link>
              </div>
